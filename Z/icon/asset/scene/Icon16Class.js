...
// --- header ----------------------------------------------
function Icon16Class(sceneID, classID) {
    BaseScene.call(this, sceneID, classID);
}

Icon16Class.prototype.__proto__  = BaseScene.prototype;
Icon16Class.prototype.update     = Icon16Class_update; // override
Icon16Class.prototype.updateView = Icon16Class_updateView;

// --- library scope vars ----------------------------------

// --- implement -------------------------------------------
function Icon16Class_update(eventType,  // @arg String: "build", "show", "hide", "destroy"
...
function Icon16Class_updateView() {
    // your code here
    var zabuton = Zabuton.getInstance();
    var term = Date.now() - zabuton.scene().getInfo().transition.start;

//    document.title = "Icon16(" + term + "ms)";

    document.body.insertBefore(
        document.createTextNode("icon16: " + term + ". "),
...
if (typeof module !== "undefined") { // module
    module.exports = { Icon16Class: Icon16Class };
} else {
    global.Icon16Class = Icon16Class;
}
